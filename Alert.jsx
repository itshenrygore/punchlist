                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="search-result-meta">
                        ...
                        <span className={`status-chip ${toneForStatus(qt.status)}`} style={{ fontSize: 'var(--text-2xs)', padding: '2px 7px' }}>{chipForStatus(qt.status)}</span>
                      </div>
                    </button>
                  );
                })}
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="search-result-meta">
                        ...
                        <span className={`status-chip ${b.status === 'confirmed' ? 'approved' : b.status === 'cancelled' ? 'declined' : 'sent'}`} style={{ fontSize: 'var(--text-2xs)', padding: '2px 7px' }}>{b.status}</span>
                      </div>
                    </button>
                  );
                })}
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="search-result-meta">
                        ...
                        <span className={`status-chip ${inv.status === 'paid' ? 'paid' : inv.status === 'overdue' ? 'overdue' : 'sent'}`} style={{ fontSize: 'var(--text-2xs)', padding: '2px 7px' }}>{inv.status}</span>
                      </div>
                    </button>
                  );
                })}
