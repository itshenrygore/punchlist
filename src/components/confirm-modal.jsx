      ...
      <div className="modal-content" onClick={(e) => e.stopPropagation()} style={{ maxWidth: 420 }}>
        ...
        <div style={{ display: 'flex', gap: 10, justifyContent: 'flex-end' }}>
          <button
            ...
            onClick={onCancel}
            style={{ padding: '8px 18px', borderRadius: 'var(--r)', fontSize: 'var(--text-base)', fontWeight: 600, cursor: 'pointer', background: 'var(--panel-3)', color: 'var(--text)', border: '1px solid var(--line)' }}
          >
            {cancelLabel}
          </button>
          <button
