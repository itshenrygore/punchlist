  ...
  return (
    <span
      ...
      style={{
        ...
        boxShadow:
          'inset 0 1px 0 var(--logo-glass-highlight, rgba(255,255,255,0.24)), 0 2px 6px rgba(0,0,0,0.12)',
    ...
    >
      ...
      >
        ...
        <rect x="224" y="192" width="140" height="44" rx="12" fill={rowFill} opacity="0.65" />
        <rect x="224" y="272" width="160" height="44" rx="12" fill={rowFill} opacity="0.4" />
