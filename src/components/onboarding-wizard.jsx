  ...
  return (
    <div className="ob-backdrop">
      <div className="ob-card" style={{ position: 'relative' }}>
        ...
        {step === 0 && (
          <>
            <div style={{ fontSize: 'var(--text-2xs)', fontWeight: 600, color: 'var(--brand)', textAlign: 'center', marginBottom: 4 }}>Step 1 of 2</div>
        ...
        {step === 1 && (() => {
          ...
          return (
          <>
            <div style={{ fontSize: 'var(--text-2xs)', fontWeight: 600, color: 'var(--brand)', textAlign: 'center', marginBottom: 4 }}>Step 2 of 2 — you're ready to go</div>
