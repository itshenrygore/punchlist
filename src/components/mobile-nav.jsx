...
export default function MobileNav() {
  ...
  return (
    <nav className="mobile-bottom-nav" aria-label="Main navigation">
      ...
      <NavLink to="/app/bookings" className={() => `mobile-nav-item${isTabActive('/app/bookings') ? ' active' : ''}`}>
      ...
      <NavLink to="/app/invoices" className={() => `mobile-nav-item${isTabActive('/app/invoices') ? ' active' : ''}`}>
