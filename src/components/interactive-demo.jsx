...
export default function InteractiveDemo({ inline = false }) {
 ...
 id-preview-toggle pl-toggle-row idmo-fs-sm-3a91{doneRevealing && total > 0 && (
 <button className="id-preview-toggle pl-toggle-row" type="button" onClick={() => setShowPreview(p => !p)} >
