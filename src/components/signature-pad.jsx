...
export default function SignaturePad({
 ...
 <div className="spad-s4-f682">
 <label className="spad-block_fs-sm-aae2">Full name</label>
 ...
 className="spad-fs-base-afce" />
 </div>

 <div className="spad-flex-ea97">
 ...
 {tab === 'draw' && (
 <>
 <label className="spad-block_fs-sm-aae2">Signature</label>
 <div className="spad-s3-70b0">
 <canvas ref={canvasRef} className="spad-block-a1a3"
 onMouseDown={startDraw} onMouseMove={draw} onMouseUp={endDraw} onMouseLeave={endDraw}
 onTouchStart={startDraw} onTouchMove={draw} onTouchEnd={endDraw} />
 {!hasStrokes && <div className="spad-fs-sm-8fa1">Sign here with your finger or mouse</div>}
 </div>
 {hasStrokes && <button type="button" onClick={clearPad} className="spad-fs-xs-efe3">Clear signature</button>}
 </>
 )}

 {tab === 'type' && (
 <>
 <label className="spad-block_fs-sm-aae2">Type your name to sign</label>
 <input type="text" value={typedName} onChange={e => setTypedName(e.target.value)} placeholder="Your name"
 className="spad-fs-base-c775" />
 {typedName.trim() && (
 <>
 <div className="spad-fs-xs-424f">Preview</div>
 <div className="spad-s2-a691">
 <canvas ref={typeCanvasRef} className="spad-block-4875" />
 </div>
 </>
 )}
 </>
 ...
 <div className="spad-fs-sm-3174">
 Please read and accept the terms &amp; conditions above before signing.
 doc-cta-primary spad-s1-f72f )}

 <div className="spad-flex-a60c">
 <button className="doc-cta-primary" type="button"doc-cta-secondary spad-s0-b30fve} onClick={handleSave} >
 {saveLabel}
 </button>
 <button className="doc-cta-secondary" type="button" onClick={onCancel} >Cancel</button>
 </div>
 <p className="spad-ta-center_fs-2xs-7a81">
 {legalText}
 </p>
 </div>
 );
