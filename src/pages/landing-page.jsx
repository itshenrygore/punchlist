      ...
      <section className="ln-sec">
        <div className="ln-w">
          ...
          <div className="testi-feature rv">
            <div className="testi-feature-badge">$13,750 closed · No negotiation · Deposit paid on site</div>
            <blockquote className="testi-feature-quote">
              "Panel upgrades get shopped to death on price. I quoted $631/month over 24 months
              instead of the $13,750 lump sum. Customer didn't ask for a second quote.
            ...
            {[
              {
                ...
                quote: 'Customer called my $9,180 furnace and AC quote "too much." Sent it back showing $421/month over 24 months and they approved it the next morning. I send every quote over $3k this way now.',
                name: 'Dave Kowalski', trade: 'HVAC Technician · Edmonton, AB', initials: 'DK',
              },
              {
                amount: '$7,440 closed', result: 'Approved same evening',
                quote: 'Customer went dead silent when I said $7,440 for a main drain replacement. Sent it back at $341/month over 24 months — approved that evening. I was skeptical about financing, but I\'m not financing anything. The lender does.',
