...
function LpFaq() {
 ...
 <button type="button" onClick={() => setOp(op===i?null:i)} className="lp-faq-q"><span>{q}</span><ChevronDown size={16} className="lp-faq-chevron"/></button>
