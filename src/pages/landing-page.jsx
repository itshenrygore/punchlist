...
/* ── Jobs marquee data ── */
const MARQUEE = [
  { amount: '$10,800', job: 'Furnace + AC replacement', city: 'Edmonton, AB' },
  { amount: '$14,000', job: 'Panel upgrade to 200A', city: 'Vancouver, BC' },
  { amount: '$7,400',  job: 'Main drain replacement', city: 'Calgary, AB' },
  { amount: '$22,500', job: 'Kitchen renovation', city: 'Toronto, ON' },
  { amount: '$12,600', job: 'Roof replacement', city: 'Ottawa, ON' },
  { amount: '$8,900',  job: 'Full bathroom reno', city: 'Burnaby, BC' },
  { amount: '$9,200',  job: 'Boiler swap + radiators', city: 'Mississauga, ON' },
  { amount: '$6,400',  job: 'Basement electrical + panel', city: 'Regina, SK' },
];
          ...
          <div className="wf-grid">
            ...
            <div className="wf-step rv">
              ...
              <div className="wf-vis wf-vis--scope">
                ...
                {[
                  ['Remove & dispose of existing furnace + AC', '$480'],
                  ['Supply & install gas furnace — 96% AFUE, 80k BTU', '$4,200'],
                  ['Supply & install central AC — 3.5 ton, 16 SEER', '$4,600'],
                  ['Lineset, flue liner, electrical & Ecobee thermostat', '$1,520'],
                ].map(([name, price], i) => (
                ...
                <div className="wf-scope-total"><span>Total</span><span>$10,800</span></div>
              </div>
            </div>
            ...
            <div className="wf-step rv rv--d1">
              ...
              <div className="wf-vis wf-vis--price">
                ...
                <div className="wf-price-big">$450<span>/mo</span></div>
                <div className="wf-price-sub">Same $10,800. Same margin. Zero risk.</div>
                <div className="wf-price-won">✓ Approved — $10,800 paid in full</div>
              </div>
            </div>
              ...
              <div className="wf-vis wf-vis--notif">
                <div className="wf-notif rv">
                  ...
                  <div className="wf-notif-body">
                    ...
                    <div className="wf-notif-msg">Kevin opened your $10,800 quote</div>
                  </div>
        ...
        <div className="ln-w">
          ...
          <div className="testi-feature rv">
            ...
            <div className="testi-feature-who">
              ...
              <div>
                <div className="testi-name">Tyler Reimer</div>
                <div className="testi-trade">Journeyman Electrician · Vancouver, BC</div>
              </div>
            </div>
          </div>
