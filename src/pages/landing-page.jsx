...
function LpStickerShock() {
 ...
 <div className="lp-shlp-shock-amount lp-s15-3826={{opacity:flipped?0:1,transform:flipped?'scale(0.96) translateY(-6px)':'scale(1)',filter:flipped?'blur(3px)':'blur(0)'}}>
 <div className="lp-shock-amount" e-through'}}>$6,000</div>
