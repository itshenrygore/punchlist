      ...
      <div className="dv2-root motion-isolate">
        ...
        <div className="dv2-row1 dv2-enter" style={{ '--i': 0 }}>
          ...
          {!loading && pipelineValue > 0 && (
            <div className={`dv2-headline-metric ${awaitingApproval > 0 ? 'dv2-headline-metric--warning' : 'dv2-headline-metric--info'}`}>
              <span>{currency(pipelineValue)}</span>
              <span style={{ fontWeight: 500, opacity: 0.7 }}>in pipeline</span>
            </div>
          )}
        </div>
              ...
              {recentQuotes.map((q, i) => {
                ...
                return (
                  <Link
                    ...
                    className="dv2-arow dv2-enter"
                    style={{ '--i': i + 3, textDecoration: 'none' }}
                  >
                    <span className={`dv2-arow-dot ${dotClass}`} />
