...
export default function InvoiceDetailPage() {
 ...
 <span>Item</span><span className="idp-ta-right-a1ae">Qty</span><span className="idp-ta-right-a1ae">Price</span><span/>
 </div>
...
btn btn-primary idp-s6-f72f <div className="idp-flex-353f">
 ...
 <a href={customerUrl} target="_blank" rel="noreferrer" className="qd-share-link">Preview customer view ↗</a>
 <button className="btn btn-secondary full-width" type="button" onClick={startEditing} >
 Edit invoice
 </button>
 {!showPartialForm && !showPayForm ? (
 <div className="idp-grid-9954">
