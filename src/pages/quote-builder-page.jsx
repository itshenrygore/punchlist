        ...
        {phase === 'describe' && (
          <Card padding="loose" className="qb-zone pl-describe-stable" elevation={1}>
            ...
            <div className="jd-footer qb-footer-mt">
              <button className="btn btn-primary btn-lg full-width" type="button" onClick={handleBuildScope} disabled={!description.trim() || scopeLoading}>{scopeLoading ? 'Building…' : description.trim() ? `Build Quote →` : 'Describe the job to get started'}</button>
