...
export default function BookingsPage() {
 ...
 <span className="bkp-fs-xs-b2de">{drawerBooking.notes}</span>
 </div>
 )}
 ...
 <div key={c.id} className="bkp-s0-c9b4">
 ...
 <div className="bkp-fs-2xs-fb82">Tap "Save" again to keep this time.</div>
 </div>
 )}
 {drawerBooking.customer?.email && (
 <div className="bkp-fs-2xs-900a">
 ...
 <disched-rail-count bkp-s2-88d2ed-drawer-header">
 <div>
 <span className="eyebrow">Needs scheduling</span>
 <span className="sched-rail-count" >{needsScheduling.length}</span>
 </div>
 ...
 sched-modal bkp-s1-0843irm && (
 <div className="sched-modal-overlay" onClick={() => setDragConfirm(null)}>
 <div className="sched-modal" onClick={e => e.stopPropagation()} role="dialog" aria-modal="true" aria-label="Schedule conflict">
