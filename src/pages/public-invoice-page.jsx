                  ...
                  <div className="doc-info-body">
                    ...
                    {invoice.stripe_connect_enabled ? (
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginTop: 10, marginBottom: 6 }}>
                        <button className="doc-cta-primary" onClick={handleConnectPay} disabled={payLoading} style={{ textAlign: 'center', fontSize: 'var(--text-md)', padding: '14px 18px', border: 'none', cursor: 'pointer', fontWeight: 700 }}>
