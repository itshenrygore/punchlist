...
export default function PaymentsSetupPage() {
 ...
 <div className="psp-flex_fs-base-ba4f"Shrink: 0 }}>1</div>
 ...
 <div className="psp-flex-64c8">
 <div className="psp-flex_fs-base-ba4f"Shrink: 0 }}>2</div>
 ...
 <div className="psp-flex-64c8">
 <div className="psp-flex_fs-base-ba4f"Shrink: 0 }}>3</div>
 ...
 <span className="psp-fs-xs-80c9" lineHeight: 1.5 }}>{desc}</span>
 </div>
 </div>
 ))}
 </div>
 ...
 {/* CTA */}
 <div className="panel" nd-line)' }}>
 <div className="psp-fs-md-f7e3">Ready to accept payments?</div>
 <p className="muted small" sm-8568auto' }}>Go to Settings → Payment Methods and click "Connect with Stripe." It takes about 10 minutes.</p>
 ...
 {/* FAQ */}
 <div>
 <h2 className="psp-fs-xl-211b"0 0 16px' }}>Common questions</h2>
