...
export default function SignupPage() {
 ...
 <div className="sup-flex-68d2"><span className="sup-s10-58b7">3.</span><span>Send to your customer — they seeeyebrow sup-s9-78e5+ monthly option</span></div>
 </div>
 </div>
 ...
 <div className="sup-ta-center_fs-2xs-32a8">Used by plumbers, electricians, HVAC techs, and contractors across Canada</div>
 <div className="muted small">
