  ...
  const FM = [
    {
      m: [
        ...
        {
          r: 'b',
          t: 'Classic one. Here\'s what gets missed 90% of the time:<br><br>' +
            '• <strong>Shut-off valves</strong> — if they\'re original, swap them now or you\'re coming back free<br>' +
            '• <strong>Supply lines</strong> — braided stainless, not the old chrome. $18 in parts, $0 in callbacks<br>' +
            '• <strong>Disposal fee</strong> — old faucet doesn\'t vanish. Charge it or eat it<br><br>' +
            'That\'s $145–$210 most guys leave on the table. Want me to add them to the quote?'
        },
        { r: 'u', t: 'Add them' },
        { r: 't' },
        {
          r: 'b',
          t: '3 line items added. Quote updated: <strong>$625 → $835</strong><br><br>That\'s $210 you would\'ve missed.',
    ...
    },
    {
      m: [
        ...
        {
          r: 'b',
          t: 'That\'s not a quick fix. Green patina on the supply line = active corrosion. It\'s weeping at the joint.<br><br>' +
            '<strong>Don\'t patch it.</strong> Replace the valve and 6" of line both sides. If you solder over corrosion, you\'re back in 3 months — for free.<br><br>' +
            'Parts ~$35, labour 45 min. Quote it at <strong>$265</strong>, not $85.',
          a: 'Add to quote →'
        },
      ],
    },
    ...
    <>
      <div className="landing-page">
          ...
          <div className="container fm-section-grid">
            <div className="fm-section-copy">
              ...
              <div className="fm-features">
                {[
                  ['🔍', 'Catches missed line items', '"You quoted a faucet swap but didn\'t include shut-off valves or supply lines — that\'s $210 you\'d lose"'],
        ...
        <section className="section section-alt">
          <div className="container narrow">
            <div className="section-head"><div className="eyebrow-sm">From the field</div><h2>Contractors don't stay because it's fast. They stay because they make more.</h2></div>
            <div className="testimonials">
              {[
                ['"Sent the quote from the customer\'s driveway. They approved it before I got home. That never happened when I was texting estimates."', '— Plumber, Calgary', '$835 kitchen faucet job'],
                ['"It flagged the shut-off valves and disposal fee I always forget. That one catch was $210 I would\'ve eaten. Punchlist paid for itself on the first job."', '— Plumber, Vancouver', 'Paid for itself day one'],
