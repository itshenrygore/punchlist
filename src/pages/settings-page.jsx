...
function PushToggle({ userId }) {
 ...
 return (
 <div>
 <div className="sp-flex_fs-sm-4db3">✓ Push notifications enabled</div>
...
export default function SettingsPage() {
 ...
 <img src={form.logo_url} alt="Logo preview" className="sp-s40-b1ce" onError={e => { e.target.style.display = 'none'; }} />
 ...
 <div className="sp-s22-dcb5">${PRICING.monthly}</div>
