...
// ── HANDYMAN (45 items) ──
{t:'Handyman',c:'Services',n:'Service call / assessment',d:'On-site evaluation and diagnosis of issue',lo:75,hi:150,p:100,syn:['service call','assessment','estimate','callout','trip charge']},
{t:'Handyman',c:'Services',n:'Disposal and cleanup',d:'Haul away debris, clean work area',lo:40,hi:100,p:60,syn:['disposal','cleanup','haul away','dump run']},
{t:'Handyman',c:'Labour',n:'Mount TV on wall',d:'Mount flat-screen TV, conceal cables if possible',lo:120,hi:250,p:95,syn:['tv mount','mount tv','wall mount','hang tv','tv bracket']},
{t:'Handyman',c:'Labour',n:'Install shelving',d:'Mount shelves on wall — floating, bracket, or built-in',lo:80,hi:200,p:90,syn:['shelves','shelf','floating shelf','bracket shelf','wall shelf']},
{t:'Handyman',c:'Labour',n:'Assemble furniture',d:'Assemble flat-pack furniture (IKEA, Wayfair, etc.)',lo:80,hi:200,p:88,syn:['furniture assembly','ikea','assemble','flat pack','build furniture']},
{t:'Handyman',c:'Labour',n:'Install curtain rod / blinds',d:'Measure, drill, and mount curtain rod or blinds',lo:60,hi:150,p:85,syn:['curtain rod','blinds','window coverings','drapes','roller shade']},
{t:'Handyman',c:'Labour',n:'Repair drywall hole',d:'Patch and sand small to medium drywall holes',lo:80,hi:200,p:92,syn:['drywall hole','patch hole','wall repair','drywall patch']},
{t:'Handyman',c:'Labour',n:'Fix leaky faucet',d:'Replace cartridge, washer, or O-ring to stop leak',lo:85,hi:180,p:90,syn:['leaky faucet','dripping faucet','faucet repair','tap leak']},
{t:'Handyman',c:'Labour',n:'Replace light fixture',d:'Swap out ceiling or wall light fixture',lo:80,hi:180,p:88,syn:['light fixture','replace light','swap light','ceiling light','wall sconce']},
{t:'Handyman',c:'Labour',n:'Replace outlet / switch',d:'Swap outlet, switch, or cover plate',lo:60,hi:130,p:82,syn:['outlet','switch','cover plate','receptacle','light switch']},
{t:'Handyman',c:'Labour',n:'Install door hardware',d:'Install or replace deadbolt, handle set, or hinge',lo:60,hi:150,p:80,syn:['door knob','deadbolt','door handle','door hardware','lock install']},
{t:'Handyman',c:'Labour',n:'Hang door',d:'Install interior pre-hung or slab door',lo:150,hi:350,p:78,syn:['hang door','install door','interior door','pre-hung door']},
{t:'Handyman',c:'Labour',n:'Fix running toilet',d:'Replace flapper, fill valve, or handle',lo:65,hi:140,p:85,syn:['running toilet','toilet repair','flapper','fill valve']},
{t:'Handyman',c:'Labour',n:'Caulking — kitchen or bath',d:'Remove old caulk, clean, and re-caulk tub/shower/sink',lo:60,hi:140,p:82,syn:['caulking','caulk','recaulk','silicone','grout repair']},
{t:'Handyman',c:'Labour',n:'Install weatherstripping',d:'Apply weatherstripping to doors or windows',lo:50,hi:120,p:65,syn:['weatherstrip','draft','door seal','window seal','weather seal']},
{t:'Handyman',c:'Labour',n:'Install smoke / CO detector',d:'Mount and test smoke or carbon monoxide detector',lo:40,hi:90,p:75,syn:['smoke detector','co detector','fire alarm','carbon monoxide']},
{t:'Handyman',c:'Labour',n:'Install thermostat',d:'Replace or install programmable or smart thermostat',lo:80,hi:180,p:72,syn:['thermostat','smart thermostat','nest','ecobee','honeywell']},
{t:'Handyman',c:'Labour',n:'Toilet replacement',d:'Remove old toilet, install new, test',lo:180,hi:350,p:80,syn:['toilet install','replace toilet','new toilet']},
{t:'Handyman',c:'Labour',n:'Install towel bar / accessories',d:'Mount towel bar, toilet paper holder, hooks',lo:40,hi:100,p:70,syn:['towel bar','tp holder','bathroom accessories','hooks','robe hook']},
{t:'Handyman',c:'Labour',n:'Deck / fence repair',d:'Replace broken boards, re-secure posts or rails',lo:120,hi:350,p:75,syn:['deck repair','fence repair','board replacement','railing fix']},
{t:'Handyman',c:'Labour',n:'Gutter cleaning',d:'Clear gutters and downspouts of debris',lo:100,hi:250,p:70,syn:['gutter cleaning','eavestrough cleaning','clean gutters']},
{t:'Handyman',c:'Labour',n:'Pressure washing',d:'Pressure wash deck, driveway, patio, or siding',lo:150,hi:400,p:68,syn:['pressure wash','power wash','deck wash','driveway cleaning']},
{t:'Handyman',c:'Labour',n:'Paint touch-up',d:'Touch up scuffs, marks, or small areas',lo:80,hi:200,p:72,syn:['touch up','paint repair','spot paint','scuff repair']},
{t:'Handyman',c:'Labour',n:'Install closet organizer',d:'Mount closet shelf and rod system or wire organizer',lo:100,hi:280,p:65,syn:['closet organizer','closet system','shelf and rod','closet install']},
{t:'Handyman',c:'Labour',n:'Install mailbox / house numbers',d:'Mount mailbox or house number set',lo:40,hi:100,p:55,syn:['mailbox','house numbers','address numbers','post mount']},
{t:'Handyman',c:'Labour',n:'Picture / mirror hanging',d:'Hang pictures, mirrors, or artwork (anchored)',lo:40,hi:100,p:60,syn:['hang picture','hang mirror','artwork','wall art']},
{t:'Handyman',c:'Labour',n:'Baby-proofing',d:'Install safety gates, cabinet locks, outlet covers',lo:80,hi:200,p:55,syn:['baby proof','child safety','safety gate','cabinet lock']},
{t:'Handyman',c:'Labour',n:'Install grab bars',d:'Mount grab bars in shower, tub, or by toilet (blocking required)',lo:80,hi:180,p:65,syn:['grab bar','safety bar','shower bar','accessibility']},
{t:'Handyman',c:'Labour',n:'Fix squeaky floor',d:'Locate and screw down squeaky subfloor areas',lo:80,hi:200,p:60,syn:['squeaky floor','floor squeak','creaky floor','subfloor']},
{t:'Handyman',c:'Labour',n:'Replace dryer vent',d:'Replace or reroute dryer vent duct and exterior hood',lo:100,hi:250,p:62,syn:['dryer vent','vent cleaning','dryer duct','lint vent']},
{t:'Handyman',c:'Materials',n:'General hardware and supplies',d:'Screws, anchors, brackets, caulk, tape, misc consumables',lo:15,hi:60,p:50,syn:['hardware','supplies','screws','anchors','consumables']},
{t:'Handyman',c:'Labour',n:'Hourly rate — general labour',d:'Handyman general labour (per hour)',lo:65,hi:120,p:98,syn:['hourly','per hour','general labour','time and materials','t&m']},

// ── DRYWALL (35 items) ──
{t:'Drywall',c:'Services',n:'Drywall assessment',d:'Evaluate scope — patches, full hang, or repair',lo:75,hi:150,p:95,syn:['assessment','estimate','evaluation','inspection']},
{t:'Drywall',c:'Services',n:'Disposal and cleanup',d:'Remove debris, dust control, cleanup',lo:50,hi:120,p:55,syn:['cleanup','disposal','haul away','dust control']},
{t:'Drywall',c:'Labour',n:'Hang drywall — per sheet',d:'Measure, cut, and hang one 4×8 sheet',lo:35,hi:65,p:98,syn:['hang drywall','sheet','board','gyproc','gypsum']},
{t:'Drywall',c:'Labour',n:'Tape and mud — per sheet',d:'Apply tape, three coats of compound, sand smooth',lo:30,hi:55,p:97,syn:['tape','mud','compound','finish','joint compound']},
{t:'Drywall',c:'Labour',n:'Small hole patch (up to 6")',d:'Cut patch, mesh tape, compound, sand and prime',lo:65,hi:140,p:95,syn:['patch','hole','small patch','repair','wall hole']},
{t:'Drywall',c:'Labour',n:'Large hole patch (6–24")',d:'Cut backer, install new piece, tape, mud, sand',lo:100,hi:250,p:90,syn:['large patch','big hole','section repair']},
{t:'Drywall',c:'Labour',n:'Water damage repair',d:'Cut out damaged area, replace, tape and finish',lo:150,hi:400,p:85,syn:['water damage','water stain','leak repair','moisture damage']},
{t:'Drywall',c:'Labour',n:'Ceiling repair',d:'Repair ceiling drywall — crack, sag, or hole',lo:120,hi:350,p:82,syn:['ceiling','ceiling crack','ceiling sag','ceiling repair']},
{t:'Drywall',c:'Labour',n:'Skim coat — per wall',d:'Full skim coat for smooth finish over texture or damage',lo:120,hi:300,p:78,syn:['skim coat','smooth wall','level 5','venetian']},
{t:'Drywall',c:'Labour',n:'Remove popcorn ceiling',d:'Scrape, patch, prime popcorn texture ceiling',lo:200,hi:500,p:80,syn:['popcorn ceiling','stipple','texture removal','scrape ceiling']},
{t:'Drywall',c:'Labour',n:'Apply ceiling texture',d:'Apply knockdown, orange peel, or stipple texture',lo:150,hi:400,p:72,syn:['texture','knockdown','orange peel','stipple','ceiling texture']},
{t:'Drywall',c:'Labour',n:'Hang and finish full room',d:'Complete drywall for one standard room — hang, tape, mud, sand',lo:600,hi:1500,p:88,syn:['full room','room drywall','complete room']},
{t:'Drywall',c:'Labour',n:'Hang and finish basement',d:'Full basement drywall — hang, tape, mud, sand',lo:2500,hi:6000,p:85,syn:['basement','basement finish','basement drywall']},
{t:'Drywall',c:'Labour',n:'Install corner bead',d:'Apply and finish metal or paper corner bead',lo:5,hi:12,p:70,syn:['corner bead','outside corner','corner finish']},
{t:'Drywall',c:'Labour',n:'Install bulkhead / soffit',d:'Frame and drywall bulkhead or soffit',lo:200,hi:500,p:65,syn:['bulkhead','soffit','drop ceiling frame','chase']},
{t:'Drywall',c:'Materials',n:'Drywall sheets (4×8)',d:'Standard or moisture-resistant drywall board',lo:12,hi:22,p:80,syn:['drywall','gyproc','board','sheet','mold resistant']},
{t:'Drywall',c:'Materials',n:'Joint compound (box)',d:'Box of pre-mixed joint compound',lo:15,hi:30,p:70,syn:['mud','compound','joint compound','ready mix']},
{t:'Drywall',c:'Materials',n:'Tape and supplies',d:'Paper tape, mesh tape, screws, sanding screens',lo:10,hi:35,p:60,syn:['tape','screws','sanding','supplies','mesh tape']},

// ── FLOORING (40 items) ──
{t:'Flooring',c:'Services',n:'Flooring assessment',d:'Measure, inspect subfloor, recommend approach',lo:75,hi:150,p:95,syn:['assessment','estimate','measure','inspection']},
{t:'Flooring',c:'Services',n:'Floor prep and leveling',d:'Scrape, level, and prepare subfloor for install',lo:150,hi:450,p:85,syn:['floor prep','leveling','self-leveler','subfloor prep','screed']},
{t:'Flooring',c:'Services',n:'Remove existing flooring',d:'Remove old flooring, adhesive, and prep for new',lo:100,hi:350,p:80,syn:['remove floor','demo','tear out','strip floor','pull up']},
{t:'Flooring',c:'Services',n:'Disposal and cleanup',d:'Haul away old flooring, clean jobsite',lo:50,hi:130,p:55,syn:['disposal','cleanup','haul away','dump']},
{t:'Flooring',c:'Labour',n:'Install LVP / LVT (per sqft)',d:'Install luxury vinyl plank or tile — click-lock',lo:3,hi:6,p:98,syn:['lvp','lvt','vinyl plank','luxury vinyl','click floor']},
{t:'Flooring',c:'Labour',n:'Install hardwood (per sqft)',d:'Install solid or engineered hardwood — nail or glue',lo:4,hi:9,p:95,syn:['hardwood','engineered hardwood','solid hardwood','wood floor','oak floor']},
{t:'Flooring',c:'Labour',n:'Install laminate (per sqft)',d:'Install click-lock laminate flooring with underlayment',lo:2,hi:5,p:90,syn:['laminate','click laminate','floating floor']},
{t:'Flooring',c:'Labour',n:'Install tile (per sqft)',d:'Install ceramic or porcelain tile with thinset',lo:6,hi:14,p:92,syn:['tile','ceramic','porcelain','floor tile','thinset']},
{t:'Flooring',c:'Labour',n:'Install carpet (per sqft)',d:'Install carpet with underpad, stretch and seam',lo:3,hi:7,p:78,syn:['carpet','broadloom','carpet install','underpad']},
{t:'Flooring',c:'Labour',n:'Install backsplash tile',d:'Install wall tile backsplash — prep, thinset, grout',lo:350,hi:900,p:85,syn:['backsplash','kitchen tile','wall tile','subway tile']},
{t:'Flooring',c:'Labour',n:'Install shower tile',d:'Waterproof, install tile on shower walls and floor',lo:800,hi:2200,p:80,syn:['shower tile','bathroom tile','tub surround','wet area tile']},
{t:'Flooring',c:'Labour',n:'Refinish hardwood (per sqft)',d:'Sand, stain, and finish existing hardwood floors',lo:3,hi:7,p:82,syn:['refinish','sand and stain','resand','floor refinish']},
{t:'Flooring',c:'Labour',n:'Install baseboards after floor',d:'Install or reinstall baseboards and transitions',lo:100,hi:300,p:75,syn:['baseboard','shoe moulding','quarter round','transition strip']},
{t:'Flooring',c:'Labour',n:'Stair treads / risers',d:'Install stair treads and risers — hardwood or LVP',lo:300,hi:800,p:70,syn:['stair','stair tread','stair riser','staircase','stair nose']},
{t:'Flooring',c:'Labour',n:'Grout and seal',d:'Grout tile joints and apply sealer',lo:100,hi:300,p:72,syn:['grout','seal','tile grout','grout sealer']},
{t:'Flooring',c:'Materials',n:'Underlayment (per sqft)',d:'Foam, cork, or moisture barrier underlayment',lo:0.5,hi:2,p:65,syn:['underlay','underlayment','moisture barrier','vapor barrier']},
{t:'Flooring',c:'Materials',n:'Transition strips',d:'T-mould, reducer, stair nose, end cap',lo:15,hi:50,p:60,syn:['transition','t-mould','reducer','threshold']},

// ── CONCRETE (30 items) ──
{t:'Concrete',c:'Services',n:'Site assessment',d:'Evaluate grade, drainage, and scope of concrete work',lo:100,hi:200,p:95,syn:['assessment','estimate','site visit']},
{t:'Concrete',c:'Services',n:'Excavation and grading',d:'Excavate and grade base for slab or footing',lo:300,hi:1000,p:80,syn:['excavation','grading','dig','prep','base prep']},
{t:'Concrete',c:'Services',n:'Concrete permit',d:'Municipal permit for concrete work requiring inspection',lo:80,hi:300,p:65,syn:['permit','inspection','building permit']},
{t:'Concrete',c:'Labour',n:'Pour sidewalk (per linear ft)',d:'Form, pour, and finish concrete sidewalk',lo:25,hi:55,p:95,syn:['sidewalk','walkway','path','concrete walk']},
{t:'Concrete',c:'Labour',n:'Pour driveway',d:'Form, pour, and finish concrete driveway',lo:3000,hi:8000,p:98,syn:['driveway','concrete driveway','drive pad']},
{t:'Concrete',c:'Labour',n:'Pour patio slab',d:'Form, pour, and finish backyard patio slab',lo:1500,hi:4500,p:92,syn:['patio','slab','backyard slab','concrete patio']},
{t:'Concrete',c:'Labour',n:'Pour garage pad',d:'Form and pour concrete garage floor',lo:2500,hi:6000,p:85,syn:['garage pad','garage floor','garage slab']},
{t:'Concrete',c:'Labour',n:'Stamped concrete overlay',d:'Apply decorative stamped pattern to fresh or existing concrete',lo:8,hi:18,p:78,syn:['stamped','decorative','pattern','stamped concrete']},
{t:'Concrete',c:'Labour',n:'Foundation repair — crack',d:'Inject and seal foundation wall crack',lo:300,hi:800,p:88,syn:['foundation crack','crack repair','wall crack','basement crack']},
{t:'Concrete',c:'Labour',n:'Parging / stucco repair',d:'Apply or repair parging on foundation walls',lo:200,hi:600,p:72,syn:['parging','stucco','foundation coating','cement coat']},
{t:'Concrete',c:'Labour',n:'Install concrete steps',d:'Form, pour, and finish entry steps',lo:800,hi:2500,p:80,syn:['steps','stairs','entry steps','front steps','concrete stairs']},
{t:'Concrete',c:'Labour',n:'Concrete curb',d:'Form and pour landscape or driveway curb',lo:10,hi:25,p:62,syn:['curb','edging','concrete curb','border']},
{t:'Concrete',c:'Labour',n:'Mudjacking / foam leveling',d:'Lift and level sunken concrete via injection',lo:500,hi:1500,p:70,syn:['mudjacking','foam jacking','slab jacking','leveling']},
{t:'Concrete',c:'Labour',n:'Concrete sealing',d:'Apply protective sealer to concrete surface',lo:150,hi:400,p:60,syn:['sealer','concrete seal','surface sealer','protect']},
{t:'Concrete',c:'Materials',n:'Ready-mix concrete (per yard)',d:'Ready-mix delivered concrete',lo:180,hi:280,p:75,syn:['concrete','ready mix','yard','cubic yard']},
{t:'Concrete',c:'Materials',n:'Rebar and wire mesh',d:'Reinforcement steel for slab or footing',lo:50,hi:200,p:65,syn:['rebar','wire mesh','reinforcement','steel']},

// ── FENCING (25 items) ──
{t:'Fencing',c:'Services',n:'Fence assessment / line marking',d:'Measure property line, mark posts, assess scope',lo:75,hi:150,p:95,syn:['assessment','measure','survey','line marking']},
{t:'Fencing',c:'Services',n:'Fence permit',d:'Municipal fence permit if required',lo:50,hi:200,p:60,syn:['permit','fence permit']},
{t:'Fencing',c:'Services',n:'Old fence removal',d:'Remove and dispose of existing fence',lo:150,hi:500,p:70,syn:['remove fence','demolition','tear down','disposal']},
{t:'Fencing',c:'Labour',n:'Wood privacy fence (per linear ft)',d:'Install 6ft wood privacy fence — posts, rails, boards',lo:30,hi:65,p:98,syn:['privacy fence','wood fence','cedar fence','board fence']},
{t:'Fencing',c:'Labour',n:'Chain link fence (per linear ft)',d:'Install chain link fence with posts and top rail',lo:18,hi:40,p:85,syn:['chain link','chainlink','wire fence','metal fence']},
{t:'Fencing',c:'Labour',n:'Vinyl / PVC fence (per linear ft)',d:'Install vinyl fence panels with posts',lo:35,hi:75,p:80,syn:['vinyl fence','pvc fence','white fence','maintenance free']},
{t:'Fencing',c:'Labour',n:'Iron / ornamental fence (per linear ft)',d:'Install decorative iron or aluminum fence',lo:40,hi:90,p:72,syn:['iron fence','ornamental','aluminum fence','wrought iron']},
{t:'Fencing',c:'Labour',n:'Install gate — single',d:'Build and hang single swing gate with hardware',lo:200,hi:500,p:90,syn:['gate','swing gate','walk gate','garden gate']},
{t:'Fencing',c:'Labour',n:'Install gate — double / driveway',d:'Build and hang double gate for driveway access',lo:400,hi:1000,p:82,syn:['double gate','driveway gate','drive gate','wide gate']},
{t:'Fencing',c:'Labour',n:'Fence post replacement',d:'Remove and replace one damaged or rotted post',lo:100,hi:250,p:78,syn:['post','replace post','rotted post','broken post']},
{t:'Fencing',c:'Labour',n:'Fence board replacement',d:'Replace damaged or missing fence boards',lo:60,hi:150,p:75,syn:['board','replace board','broken board','fence repair']},
{t:'Fencing',c:'Labour',n:'Fence stain / seal',d:'Stain or seal wood fence for protection',lo:150,hi:400,p:65,syn:['stain','seal','fence stain','wood treatment','fence paint']},
{t:'Fencing',c:'Materials',n:'Fence posts (each)',d:'4×4 or 6×6 treated post',lo:10,hi:30,p:60,syn:['post','fence post','treated post']},
{t:'Fencing',c:'Materials',n:'Fence boards and rails',d:'Fence pickets, rails, and fasteners per section',lo:30,hi:80,p:55,syn:['boards','pickets','rails','section']},

// ── WINDOWS & DOORS (35 items) ──
{t:'Windows & Doors',c:'Services',n:'Window / door assessment',d:'Measure, inspect, and recommend replacement or repair',lo:75,hi:150,p:95,syn:['assessment','measure','inspection','estimate']},
{t:'Windows & Doors',c:'Services',n:'Window permit',d:'Building permit for window/door installation',lo:80,hi:250,p:55,syn:['permit','building permit']},
{t:'Windows & Doors',c:'Labour',n:'Replace single window',d:'Remove old, install new window, insulate, trim',lo:300,hi:700,p:98,syn:['window replacement','replace window','new window','single window']},
{t:'Windows & Doors',c:'Labour',n:'Replace basement window',d:'Remove old, install new basement or hopper window',lo:250,hi:550,p:85,syn:['basement window','hopper','cellar window']},
{t:'Windows & Doors',c:'Labour',n:'Install egress window',d:'Cut opening, install well, window, and frame',lo:2000,hi:5000,p:78,syn:['egress','egress window','basement egress','escape window']},
{t:'Windows & Doors',c:'Labour',n:'Install patio door',d:'Remove old, install new sliding or French patio door',lo:500,hi:1200,p:90,syn:['patio door','sliding door','french door','garden door']},
{t:'Windows & Doors',c:'Labour',n:'Install entry door',d:'Remove old, install new entry door with hardware',lo:400,hi:900,p:92,syn:['entry door','front door','exterior door','main door']},
{t:'Windows & Doors',c:'Labour',n:'Install interior door',d:'Hang pre-hung interior door, trim, and hardware',lo:200,hi:450,p:88,syn:['interior door','bedroom door','closet door','pre-hung']},
{t:'Windows & Doors',c:'Labour',n:'Install screen door',d:'Mount screen or storm door on exterior frame',lo:100,hi:250,p:72,syn:['screen door','storm door','screen install']},
{t:'Windows & Doors',c:'Labour',n:'Install door trim / casing',d:'Install or replace door casing and trim',lo:80,hi:200,p:70,syn:['door trim','casing','door casing','trim install']},
{t:'Windows & Doors',c:'Labour',n:'Install window trim / casing',d:'Install or replace window casing and sill',lo:80,hi:200,p:68,syn:['window trim','window casing','window sill','apron']},
{t:'Windows & Doors',c:'Labour',n:'Weatherstripping — per door/window',d:'Install or replace weatherstripping for draft control',lo:30,hi:80,p:65,syn:['weatherstrip','draft','seal','weather seal']},
{t:'Windows & Doors',c:'Labour',n:'Replace glass pane',d:'Remove broken pane, install new glass, re-glaze',lo:100,hi:300,p:75,syn:['broken glass','replace glass','window glass','reglazing']},
{t:'Windows & Doors',c:'Labour',n:'Install window film / tint',d:'Apply UV, privacy, or decorative window film',lo:50,hi:150,p:55,syn:['window film','tint','privacy film','uv film']},
{t:'Windows & Doors',c:'Materials',n:'Window unit (standard)',d:'Vinyl or fiberglass casement or slider window',lo:250,hi:700,p:80,syn:['window','vinyl window','casement','slider','double hung']},
{t:'Windows & Doors',c:'Materials',n:'Entry door with frame',d:'Steel or fiberglass entry door with frame and hardware',lo:400,hi:1200,p:75,syn:['door','entry door','steel door','fiberglass door']},

// ── SIDING (25 items) ──
{t:'Siding',c:'Services',n:'Siding assessment',d:'Inspect exterior, measure, and recommend approach',lo:75,hi:150,p:95,syn:['assessment','estimate','inspection']},
{t:'Siding',c:'Services',n:'Siding permit',d:'Building permit for exterior cladding work',lo:80,hi:250,p:55,syn:['permit','building permit']},
{t:'Siding',c:'Labour',n:'Install vinyl siding (per sqft)',d:'Install vinyl siding with house wrap and trim',lo:4,hi:9,p:98,syn:['vinyl siding','siding install','lap siding']},
{t:'Siding',c:'Labour',n:'Install fiber cement siding (per sqft)',d:'Install Hardie or fiber cement board with trim',lo:7,hi:15,p:90,syn:['hardie','fiber cement','hardieplank','cement board']},
{t:'Siding',c:'Labour',n:'Install board and batten',d:'Install vertical board and batten exterior',lo:8,hi:16,p:78,syn:['board and batten','vertical siding','b&b']},
{t:'Siding',c:'Labour',n:'Install soffit and fascia',d:'Remove old, install new soffit and fascia (per linear ft)',lo:12,hi:25,p:88,syn:['soffit','fascia','overhang','eave']},
{t:'Siding',c:'Labour',n:'Siding repair — section',d:'Remove and replace damaged siding section',lo:150,hi:450,p:85,syn:['siding repair','patch','replace section','damaged siding']},
{t:'Siding',c:'Labour',n:'Install house wrap',d:'Install water-resistive barrier before siding',lo:100,hi:300,p:70,syn:['house wrap','tyvek','weather barrier','wrb']},
{t:'Siding',c:'Labour',n:'Caulk and seal exterior',d:'Seal joints, windows, and penetrations',lo:100,hi:300,p:72,syn:['caulk','seal','exterior caulk','weatherproof']},
{t:'Siding',c:'Labour',n:'Stucco repair',d:'Patch, re-coat, or repair exterior stucco',lo:200,hi:600,p:75,syn:['stucco','stucco repair','plaster','exterior plaster']},
{t:'Siding',c:'Materials',n:'Vinyl siding (per sqft)',d:'Standard vinyl siding panels',lo:2,hi:5,p:65,syn:['vinyl','siding','panels']},
{t:'Siding',c:'Materials',n:'Fiber cement siding (per sqft)',d:'Hardie or equivalent cement board siding',lo:4,hi:9,p:60,syn:['hardie','fiber cement','cement board']},

// ── GARAGE DOORS (20 items) ──
{t:'Garage Doors',c:'Services',n:'Garage door diagnostic',d:'Inspect door, opener, springs, and tracks',lo:75,hi:150,p:98,syn:['diagnostic','assessment','inspection','service call']},
{t:'Garage Doors',c:'Labour',n:'Replace garage door springs',d:'Replace torsion or extension springs (pair)',lo:180,hi:400,p:98,syn:['spring','torsion spring','extension spring','broken spring']},
{t:'Garage Doors',c:'Labour',n:'Install garage door opener',d:'Install belt, chain, or wall-mount opener with programming',lo:250,hi:500,p:95,syn:['opener','garage opener','liftmaster','chamberlain','motor']},
{t:'Garage Doors',c:'Labour',n:'Replace single garage door',d:'Remove old, install new single (8×7 or 9×7) door',lo:800,hi:1800,p:92,syn:['single door','8x7','9x7','one car','garage door replace']},
{t:'Garage Doors',c:'Labour',n:'Replace double garage door',d:'Remove old, install new double (16×7) door',lo:1200,hi:2800,p:90,syn:['double door','16x7','two car','double garage']},
{t:'Garage Doors',c:'Labour',n:'Replace garage door panels',d:'Replace damaged panel sections',lo:200,hi:600,p:80,syn:['panel','section','damaged panel','dented panel']},
{t:'Garage Doors',c:'Labour',n:'Repair or replace cables',d:'Replace frayed or broken lift cables',lo:120,hi:280,p:82,syn:['cable','lift cable','broken cable','frayed cable']},
{t:'Garage Doors',c:'Labour',n:'Track realignment / repair',d:'Straighten, realign, or replace track',lo:100,hi:250,p:78,syn:['track','realign','bent track','off track']},
{t:'Garage Doors',c:'Labour',n:'Replace rollers',d:'Replace worn or noisy rollers (set)',lo:80,hi:180,p:75,syn:['roller','wheel','nylon roller','steel roller']},
{t:'Garage Doors',c:'Labour',n:'Install keypad / remote',d:'Program and mount exterior keypad or additional remote',lo:50,hi:120,p:65,syn:['keypad','remote','clicker','wireless entry']},
{t:'Garage Doors',c:'Labour',n:'Replace weather seal',d:'Install bottom seal, side seal, or top stop',lo:60,hi:150,p:68,syn:['weather seal','bottom seal','threshold','rubber seal']},
{t:'Garage Doors',c:'Labour',n:'Smart garage integration',d:'Install WiFi module for smart home control',lo:80,hi:180,p:60,syn:['smart','wifi','myq','smart garage','home automation']},
{t:'Garage Doors',c:'Materials',n:'Torsion spring pair',d:'Standard torsion spring set rated for door weight',lo:60,hi:150,p:70,syn:['spring','torsion spring','spring pair']},

// ── APPLIANCE INSTALL (20 items) ──
{t:'Appliance Install',c:'Services',n:'Appliance delivery coordination',d:'Schedule and manage delivery of new appliance',lo:50,hi:120,p:70,syn:['delivery','coordinate','schedule']},
{t:'Appliance Install',c:'Services',n:'Old appliance disposal',d:'Disconnect, remove, and dispose of old appliance',lo:50,hi:130,p:75,syn:['disposal','remove','haul away','recycle']},
{t:'Appliance Install',c:'Labour',n:'Install dishwasher',d:'Connect water, drain, power, secure in cabinet',lo:150,hi:300,p:98,syn:['dishwasher','dishwasher install','dish washer']},
{t:'Appliance Install',c:'Labour',n:'Install washer and dryer',d:'Connect water, drain, vent, and level',lo:150,hi:350,p:95,syn:['washer','dryer','laundry','washing machine','washer dryer']},
{t:'Appliance Install',c:'Labour',n:'Install range / oven',d:'Connect gas or electric range, level, test',lo:120,hi:280,p:92,syn:['range','oven','stove','cooktop','gas range','electric range']},
{t:'Appliance Install',c:'Labour',n:'Install range hood / exhaust fan',d:'Mount hood, connect duct, wire power',lo:180,hi:400,p:85,syn:['range hood','exhaust','hood fan','vent hood','kitchen fan']},
{t:'Appliance Install',c:'Labour',n:'Install microwave — over range',d:'Mount OTR microwave, connect power and vent',lo:120,hi:250,p:82,syn:['microwave','otr','over the range','microwave install']},
{t:'Appliance Install',c:'Labour',n:'Install refrigerator / fridge',d:'Position, level, connect water line if applicable',lo:80,hi:180,p:88,syn:['fridge','refrigerator','fridge install','ice maker line']},
{t:'Appliance Install',c:'Labour',n:'Install freezer',d:'Position and level standalone freezer',lo:60,hi:130,p:65,syn:['freezer','chest freezer','upright freezer','deep freeze']},
{t:'Appliance Install',c:'Labour',n:'Install garburator / disposal',d:'Mount disposal unit under sink, connect plumbing and power',lo:150,hi:300,p:80,syn:['garburator','garbage disposal','disposal','insinkerator']},
{t:'Appliance Install',c:'Labour',n:'Install water filter system',d:'Mount under-sink or whole-home water filter',lo:120,hi:300,p:68,syn:['water filter','reverse osmosis','ro system','under sink filter']},
{t:'Appliance Install',c:'Labour',n:'Gas line connection',d:'Connect gas appliance to existing gas line',lo:100,hi:250,p:78,syn:['gas line','gas connection','gas hookup','gas flex']},
{t:'Appliance Install',c:'Labour',n:'Dryer vent install / reroute',d:'Install or reroute dryer vent duct to exterior',lo:100,hi:280,p:72,syn:['dryer vent','vent install','duct','lint vent']},

// ── RESTORATION (25 items) ──
{t:'Restoration',c:'Services',n:'Emergency response / assessment',d:'24/7 emergency response, assess damage, document',lo:200,hi:500,p:100,syn:['emergency','assessment','response','flood','water damage']},
{t:'Restoration',c:'Services',n:'Insurance claim documentation',d:'Document damage, photos, moisture readings for claim',lo:150,hi:350,p:90,syn:['insurance','claim','documentation','adjuster','photos']},
{t:'Restoration',c:'Services',n:'Moisture testing',d:'Use moisture meters and thermal imaging to map damage',lo:100,hi:250,p:88,syn:['moisture','moisture meter','thermal','moisture mapping']},
{t:'Restoration',c:'Labour',n:'Water extraction',d:'Extract standing water using truck-mount or portable',lo:300,hi:800,p:98,syn:['extraction','pump out','water removal','flood cleanup']},
{t:'Restoration',c:'Labour',n:'Set up drying equipment',d:'Place dehumidifiers, air movers, and monitor daily',lo:200,hi:500,p:95,syn:['drying','dehumidifier','air mover','dry out','equipment']},
{t:'Restoration',c:'Labour',n:'Drying equipment rental (per day)',d:'Daily charge for dehumidifiers and air movers on site',lo:75,hi:200,p:85,syn:['rental','daily','equipment rental','dehumidifier rental']},
{t:'Restoration',c:'Labour',n:'Mold remediation — small area',d:'Contain, remove, and treat mold up to 10 sqft',lo:500,hi:1500,p:90,syn:['mold','mould','remediation','small mold','spot treatment']},
{t:'Restoration',c:'Labour',n:'Mold remediation — large area',d:'Full containment, HEPA, removal, and treatment over 10 sqft',lo:2000,hi:6000,p:85,syn:['large mold','full remediation','containment','hepa']},
{t:'Restoration',c:'Labour',n:'Smoke / soot cleaning',d:'Clean soot from walls, ceilings, and surfaces',lo:300,hi:900,p:78,syn:['smoke','soot','fire cleanup','smoke damage']},
{t:'Restoration',c:'Labour',n:'Odor treatment',d:'Treat smoke, mold, or sewage odor with ozone or hydroxyl',lo:200,hi:600,p:72,syn:['odor','ozone','hydroxyl','smell','deodorize']},
{t:'Restoration',c:'Labour',n:'Demo flood-damaged materials',d:'Remove and dispose of damaged drywall, insulation, flooring',lo:300,hi:800,p:88,syn:['demo','tear out','remove damaged','gut']},
{t:'Restoration',c:'Labour',n:'Rebuild after water damage',d:'Replace drywall, flooring, trim after dry-out',lo:1500,hi:5000,p:82,syn:['rebuild','restore','replace','put back']},
{t:'Restoration',c:'Labour',n:'Sewage cleanup',d:'Clean, sanitize, and decontaminate sewage backup',lo:500,hi:2000,p:85,syn:['sewage','backup','sewage cleanup','black water','biohazard']},
{t:'Restoration',c:'Labour',n:'Asbestos testing',d:'Collect samples and lab analysis for asbestos',lo:150,hi:400,p:70,syn:['asbestos','testing','lab test','sample']},
{t:'Restoration',c:'Materials',n:'Antimicrobial treatment',d:'Spray antimicrobial on framing and subfloor',lo:100,hi:300,p:65,syn:['antimicrobial','treatment','spray','sanitize']},

// ── Additional CARPENTER items (20 items to bulk up) ──
{t:'Carpenter',c:'Labour',n:'Install interior trim package',d:'Baseboard, door casing, and window trim for one room',lo:300,hi:700,p:90,syn:['trim package','full trim','room trim','finish carpentry']},
{t:'Carpenter',c:'Labour',n:'Build custom closet',d:'Frame, shelf, rod, and trim for custom reach-in closet',lo:400,hi:1200,p:82,syn:['custom closet','closet build','reach-in','closet system']},
{t:'Carpenter',c:'Labour',n:'Install wainscoting',d:'Install wainscot paneling or board on lower wall',lo:250,hi:600,p:72,syn:['wainscoting','wainscot','chair rail','panel moulding']},
{t:'Carpenter',c:'Labour',n:'Build window seat',d:'Frame, build, and trim built-in window seat with storage',lo:500,hi:1500,p:65,syn:['window seat','built-in bench','bay window seat','storage bench']},
{t:'Carpenter',c:'Labour',n:'Install pergola / arbor',d:'Build and install wood pergola or garden arbor',lo:800,hi:2500,p:68,syn:['pergola','arbor','garden structure','shade structure']},
{t:'Carpenter',c:'Labour',n:'Repair subfloor section',d:'Cut out and replace damaged subfloor area',lo:200,hi:500,p:75,syn:['subfloor','floor repair','plywood','rotten floor']},
{t:'Carpenter',c:'Labour',n:'Install exterior trim',d:'Install or replace exterior window/door trim and fascia',lo:200,hi:500,p:70,syn:['exterior trim','fascia','brick mould','drip cap']},
{t:'Carpenter',c:'Labour',n:'Build floating shelves',d:'Install custom floating shelves with hidden brackets',lo:150,hi:400,p:78,syn:['floating shelf','wall shelf','custom shelf','display shelf']},

// ── Additional ROOFING items (20 items to bulk up) ──
{t:'Roofing',c:'Labour',n:'Full roof replacement',d:'Strip old, install new underlayment and shingles',lo:5000,hi:15000,p:98,syn:['reroof','full roof','roof replacement','new roof','strip and reshingle']},
{t:'Roofing',c:'Labour',n:'Flat roof repair',d:'Patch or re-coat flat/low-slope roof section',lo:300,hi:900,p:82,syn:['flat roof','low slope','torch on','modified bitumen']},
{t:'Roofing',c:'Labour',n:'Install skylights',d:'Cut opening, install skylight, flash, and trim',lo:800,hi:2000,p:72,syn:['skylight','roof window','velux','sun tunnel']},
{t:'Roofing',c:'Labour',n:'Install roof vents',d:'Install or replace roof vent, turbine, or ridge vent',lo:150,hi:400,p:75,syn:['roof vent','turbine vent','ridge vent','attic vent']},
{t:'Roofing',c:'Labour',n:'Install ice and water shield',d:'Apply ice/water membrane at valleys and eaves',lo:200,hi:500,p:68,syn:['ice shield','ice and water','membrane','valley protection']},
{t:'Roofing',c:'Labour',n:'Chimney flashing repair',d:'Remove old flashing, install new step and counter flashing',lo:250,hi:600,p:80,syn:['chimney flashing','step flashing','counter flashing','chimney leak']},
{t:'Roofing',c:'Labour',n:'Soffit repair / replace',d:'Replace rotted or damaged soffit panels',lo:150,hi:400,p:72,syn:['soffit repair','rotten soffit','soffit replacement']},
{t:'Roofing',c:'Labour',n:'Fascia repair / replace',d:'Replace rotted or damaged fascia board',lo:150,hi:400,p:70,syn:['fascia repair','rotten fascia','fascia board','fascia replacement']},
{t:'Roofing',c:'Labour',n:'Attic insulation top-up',d:'Blow in or batt additional attic insulation',lo:300,hi:800,p:65,syn:['insulation','attic insulation','blown in','batt','r-value']},

// ── Additional PAINTER items (20 items to bulk up) ──
{t:'Painter',c:'Labour',n:'Paint full room — walls and ceiling',d:'Prep, prime where needed, two coats walls and ceiling',lo:350,hi:800,p:98,syn:['full room','room paint','walls and ceiling','complete room']},
{t:'Painter',c:'Labour',n:'Paint kitchen cabinets',d:'Clean, sand, prime, two coats on cabinet boxes and doors',lo:1200,hi:3500,p:90,syn:['cabinet painting','kitchen cabinets','paint cabinets','cabinet refinish']},
{t:'Painter',c:'Labour',n:'Exterior house paint — full',d:'Pressure wash, scrape, prime, two coats on full exterior',lo:3000,hi:8000,p:88,syn:['exterior paint','house painting','outside paint','full exterior']},
{t:'Painter',c:'Labour',n:'Deck stain / refinish',d:'Clean, sand, apply stain or sealant to deck',lo:300,hi:800,p:80,syn:['deck stain','deck refinish','deck seal','wood stain']},
{t:'Painter',c:'Labour',n:'Wallpaper removal',d:'Strip wallpaper, repair wall, prime for paint',lo:200,hi:600,p:75,syn:['wallpaper','strip wallpaper','remove wallpaper','wallpaper removal']},
{t:'Painter',c:'Labour',n:'Install wallpaper',d:'Prep wall, hang wallpaper or mural',lo:300,hi:800,p:68,syn:['wallpaper install','hang wallpaper','mural','accent wall']},
{t:'Painter',c:'Labour',n:'Paint trim and doors — per room',d:'Sand, prime, two coats on all trim, baseboards, and doors',lo:200,hi:500,p:85,syn:['trim paint','door paint','baseboard paint','woodwork']},
{t:'Painter',c:'Labour',n:'Texture ceiling — per room',d:'Apply knockdown, orange peel, or popcorn texture',lo:150,hi:400,p:65,syn:['texture','ceiling texture','knockdown','orange peel']},
{t:'Painter',c:'Labour',n:'Epoxy garage floor',d:'Prep, etch, and apply epoxy coating to garage floor',lo:500,hi:1500,p:72,syn:['epoxy','garage floor','floor coating','garage epoxy']},
{t:'Painter',c:'Labour',n:'Paint fence / gate',d:'Prep and paint or stain fence and gate',lo:200,hi:600,p:62,syn:['fence paint','gate paint','fence stain','exterior fence']},
{t:'Painter',c:'Materials',n:'Paint and primer (per room)',d:'Quality interior latex paint and primer',lo:40,hi:100,p:70,syn:['paint','primer','latex','paint supplies']},
{t:'Painter',c:'Materials',n:'Exterior paint and primer',d:'Exterior-grade paint and primer',lo:60,hi:150,p:65,syn:['exterior paint','outdoor paint','house paint']},

// ── Additional LANDSCAPING items (20 items to bulk up) ──
{t:'Landscaping',c:'Labour',n:'Install sod lawn',d:'Grade, lay sod, roll, and water (per sqft)',lo:1,hi:3,p:95,syn:['sod','lawn','new lawn','sod install','turf']},
{t:'Landscaping',c:'Labour',n:'Build raised garden bed',d:'Build and fill raised planting bed',lo:150,hi:400,p:78,syn:['raised bed','garden bed','planter','planting bed']},
{t:'Landscaping',c:'Labour',n:'Install paver patio',d:'Excavate, base prep, and install interlocking pavers',lo:2000,hi:6000,p:90,syn:['paver','patio','interlock','interlocking','stone patio']},
{t:'Landscaping',c:'Labour',n:'Build retaining wall',d:'Excavate, base prep, and stack retaining wall blocks',lo:1500,hi:5000,p:85,syn:['retaining wall','block wall','garden wall','slope']},
{t:'Landscaping',c:'Labour',n:'Install irrigation system',d:'Design and install underground sprinkler system',lo:2000,hi:5000,p:72,syn:['irrigation','sprinkler','underground sprinkler','watering system']},
{t:'Landscaping',c:'Labour',n:'Tree removal — small/medium',d:'Cut down, remove stump, and haul away',lo:300,hi:800,p:80,syn:['tree removal','cut tree','remove tree','stump removal']},
{t:'Landscaping',c:'Labour',n:'Spring / fall cleanup',d:'Rake, trim, prune, clean beds, dispose of debris',lo:200,hi:500,p:82,syn:['spring cleanup','fall cleanup','yard cleanup','seasonal']},
{t:'Landscaping',c:'Labour',n:'Install landscape lighting',d:'Low-voltage path lights, uplights, and transformer',lo:500,hi:1500,p:68,syn:['landscape lighting','path lights','outdoor lights','uplighting']},
{t:'Landscaping',c:'Labour',n:'Grade and level yard',d:'Grade yard for drainage, level low spots',lo:300,hi:800,p:70,syn:['grading','level','drainage','yard grade','slope']},
