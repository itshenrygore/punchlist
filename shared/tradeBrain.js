...
// ── Normalize legacy/UI trade names to canonical TRADES values ──
const TRADE_NORMALIZE = {
  Roofer: 'Roofing', Plumbing: 'Plumber', Electrical: 'Electrician',
  Carpentry: 'Carpenter', Painting: 'Painter', Landscaper: 'Landscaping',
  Drywaller: 'Drywall', Taper: 'Drywall', Mudder: 'Drywall',
  'Flooring Installer': 'Flooring', Tiler: 'Flooring',
  'Mason': 'Concrete', 'Concrete Finisher': 'Concrete',
  'Fence Installer': 'Fencing', 'Window Installer': 'Windows & Doors',
  'Door Installer': 'Windows & Doors', 'Siding Installer': 'Siding',
  'Garage Door Tech': 'Garage Doors', 'Appliance Installer': 'Appliance Install',
  'Restoration Tech': 'Restoration', 'Water Damage': 'Restoration',
};
export function normalizeTrade(t) {
  if (!t) return 'Other';
  return TRADE_NORMALIZE[t] || (TRADES.includes(t) ? t : 'Other');
}
...
const TRADE_ALIASES = {
  ...
  Drywall: ['drywall','gypsum','gyproc','plaster','mudding','taping','texture','patch hole','skim coat','popcorn ceiling'],
  Flooring: ['flooring','floor','hardwood','laminate','vinyl','tile','ceramic','porcelain','carpet','lvp','lvt','grout','backsplash'],
  Concrete: ['concrete','cement','foundation','footing','sidewalk','driveway','patio slab','parging','mudjacking','stamped','curb'],
  Fencing: ['fence','fencing','gate','post','chain link','vinyl fence','wood fence','privacy fence','iron fence','fence repair'],
  'Windows & Doors': ['window','door','patio door','sliding door','entry door','casement','awning window','egress','screen door','storm door','weatherstrip','glass','glazing'],
  Siding: ['siding','vinyl siding','hardie','fiber cement','soffit','fascia','cladding','exterior trim','board and batten','stucco'],
  'Garage Doors': ['garage door','overhead door','garage opener','garage spring','garage panel','garage seal','garage motor'],
  'Appliance Install': ['appliance','dishwasher','washer','dryer','range','oven','microwave','fridge','refrigerator','hood fan','range hood','cooktop','freezer'],
  Restoration: ['restoration','water damage','flood','fire damage','mold','mould','remediation','smoke damage','sewage','drying','dehumidifier','asbestos','lead'],
};
...
/**
 * Round a price to the nearest clean number:
 *   < $20   → nearest $1
 *   $20–$99 → nearest $5
 *   ≥ $100  → nearest $10
 * Always rounds UP so quotes don't feel underpriced.
 */
...
export function regionalize(item, province = 'AB') {
  ...
  if (mult === 1.0) {
    return {
      lo: roundPrice(lo), mid: roundPrice(mid), hi: roundPrice(hi),
      price_source: 'system',
      price_note: null,
    };
  }
  return {
    lo: roundPrice(lo * mult),
    mid: roundPrice(mid * mult),
    hi: roundPrice(hi * mult),
...
// ═══════════════════════════════════════════════════════════
// PRICE ANCHORS — derived from 400 real contractor jobs
// + 2026 Canadian web pricing data (HomeStars, HomeAdvisor, etc.)
//
// These anchors compress inflated catalog prices to realistic
// market rates that match what contractors actually charge.
// ═══════════════════════════════════════════════════════════

const PRICE_ANCHORS = {
  Plumber:     { Labour: { avg: 260, p25: 160, p75: 310 }, Materials: { avg: 160, p25: 70, p75: 190 }, Services: { avg: 102, p25: 80, p75: 120 } },
  Electrician: { Labour: { avg: 370, p25: 200, p75: 480 }, Materials: { avg: 166, p25: 70, p75: 300 }, Services: { avg: 110, p25: 90, p75: 140 } },
  HVAC:        { Labour: { avg: 530, p25: 230, p75: 1000 }, Materials: { avg: 376, p25: 190, p75: 610 }, Services: { avg: 114, p25: 80, p75: 140 } },
  Carpenter:   { Labour: { avg: 280, p25: 150, p75: 400 }, Materials: { avg: 200, p25: 60, p75: 350 }, Services: { avg: 90, p25: 60, p75: 120 } },
  'General Contractor': { Labour: { avg: 280, p25: 190, p75: 360 }, Materials: { avg: 213, p25: 70, p75: 350 }, Services: { avg: 93, p25: 70, p75: 110 } },
  Roofing:     { Labour: { avg: 400, p25: 200, p75: 600 }, Materials: { avg: 350, p25: 150, p75: 500 }, Services: { avg: 120, p25: 80, p75: 160 } },
  Painter:     { Labour: { avg: 250, p25: 150, p75: 350 }, Materials: { avg: 120, p25: 50, p75: 200 }, Services: { avg: 80, p25: 50, p75: 100 } },
  Landscaping: { Labour: { avg: 200, p25: 100, p75: 300 }, Materials: { avg: 150, p25: 50, p75: 250 }, Services: { avg: 80, p25: 50, p75: 100 } },
  Drywall:     { Labour: { avg: 300, p25: 150, p75: 500 }, Materials: { avg: 80, p25: 30, p75: 150 }, Services: { avg: 90, p25: 60, p75: 120 } },
  Flooring:    { Labour: { avg: 350, p25: 180, p75: 550 }, Materials: { avg: 250, p25: 80, p75: 450 }, Services: { avg: 100, p25: 60, p75: 140 } },
  Concrete:    { Labour: { avg: 450, p25: 200, p75: 800 }, Materials: { avg: 300, p25: 100, p75: 500 }, Services: { avg: 120, p25: 80, p75: 160 } },
  Fencing:     { Labour: { avg: 250, p25: 120, p75: 400 }, Materials: { avg: 200, p25: 80, p75: 350 }, Services: { avg: 80, p25: 50, p75: 100 } },
  'Windows & Doors': { Labour: { avg: 350, p25: 180, p75: 500 }, Materials: { avg: 400, p25: 150, p75: 800 }, Services: { avg: 100, p25: 60, p75: 140 } },
  Siding:      { Labour: { avg: 400, p25: 200, p75: 600 }, Materials: { avg: 350, p25: 150, p75: 550 }, Services: { avg: 110, p25: 70, p75: 150 } },
  'Garage Doors': { Labour: { avg: 300, p25: 150, p75: 450 }, Materials: { avg: 400, p25: 200, p75: 700 }, Services: { avg: 100, p25: 70, p75: 130 } },
  'Appliance Install': { Labour: { avg: 200, p25: 100, p75: 300 }, Materials: { avg: 50, p25: 20, p75: 80 }, Services: { avg: 100, p25: 60, p75: 140 } },
  Restoration: { Labour: { avg: 500, p25: 250, p75: 800 }, Materials: { avg: 200, p25: 60, p75: 350 }, Services: { avg: 150, p25: 80, p75: 250 } },
  Handyman:    { Labour: { avg: 180, p25: 80, p75: 280 }, Materials: { avg: 80, p25: 20, p75: 150 }, Services: { avg: 75, p25: 50, p75: 100 } },
};

// Job-level price ranges — what a COMPLETE quote should total
export const JOB_PRICE_RANGES = {
  ...
  Drywall:     { simple: { lo: 200, hi: 600 }, medium: { lo: 500, hi: 2000 }, complex: { lo: 1500, hi: 5000 } },
  Flooring:    { simple: { lo: 300, hi: 800 }, medium: { lo: 700, hi: 3000 }, complex: { lo: 2500, hi: 10000 } },
  Concrete:    { simple: { lo: 300, hi: 800 }, medium: { lo: 700, hi: 3000 }, complex: { lo: 2500, hi: 15000 } },
  Fencing:     { simple: { lo: 200, hi: 600 }, medium: { lo: 500, hi: 2500 }, complex: { lo: 2000, hi: 8000 } },
  'Windows & Doors': { simple: { lo: 300, hi: 800 }, medium: { lo: 700, hi: 3000 }, complex: { lo: 2500, hi: 10000 } },
  Siding:      { simple: { lo: 300, hi: 1000 }, medium: { lo: 800, hi: 4000 }, complex: { lo: 3000, hi: 15000 } },
  'Garage Doors': { simple: { lo: 200, hi: 500 }, medium: { lo: 400, hi: 1500 }, complex: { lo: 1200, hi: 4000 } },
  'Appliance Install': { simple: { lo: 100, hi: 300 }, medium: { lo: 250, hi: 600 }, complex: { lo: 500, hi: 1500 } },
  Restoration: { simple: { lo: 500, hi: 1500 }, medium: { lo: 1200, hi: 5000 }, complex: { lo: 4000, hi: 20000 } },
  Handyman:    { simple: { lo: 100, hi: 300 }, medium: { lo: 250, hi: 800 }, complex: { lo: 700, hi: 2500 } },
};

/**
 * Compress a catalog price range using real-world anchors.
 * Prevents inflated quotes by capping hi prices at realistic market levels.
 *
 * @param {number} lo - Catalog low price
 * @param {number} hi - Catalog high price
 * @param {string} trade - Normalized trade name
 * @param {string} category - 'Labour' | 'Materials' | 'Services'
 * @returns {{ lo: number, hi: number, mid: number }}
 */
export function anchorPrice(lo, hi, trade, category) {
  const catKey = category || 'Labour';
  const anchor = (PRICE_ANCHORS[trade] || PRICE_ANCHORS['Plumber'])[catKey];
  if (!anchor) return { lo, hi: lo + (hi - lo) * 0.55, mid: Math.round(lo + (hi - lo) * 0.275) };

  // Compress the hi range: real contractor data shows hi is ~55% of the lo-to-hi spread
  const compressedHi = lo + (hi - lo) * 0.55;

  // If the compressed hi still exceeds the anchor P75 by >2x, cap it
  // This catches absurd catalog entries like "$1,500 relocate plumbing" on a faucet job
  const cap = anchor.p75 * 2;
  const finalHi = compressedHi > cap ? Math.min(compressedHi, cap) : compressedHi;
  const finalLo = lo > cap ? Math.min(lo, anchor.p75) : lo;

  return {
    lo: roundPrice(finalLo),
    hi: roundPrice(finalHi),
    mid: roundPrice((finalLo + finalHi) / 2),
  };
}

/**
 * Get the AI pricing context string for a given trade.
 * Used in the AI prompt to anchor scope generation to real data.
 */
export function getAIPricingContext(trade) {
  const ranges = JOB_PRICE_RANGES[trade] || JOB_PRICE_RANGES['Plumber'];
  const anchors = PRICE_ANCHORS[trade] || PRICE_ANCHORS['Plumber'];
  return `Job totals: simple $${ranges.simple.lo}-$${ranges.simple.hi}, medium $${ranges.medium.lo}-$${ranges.medium.hi}, complex $${ranges.complex.lo}-$${ranges.complex.hi}. `
    + `Line item avgs: labour $${anchors.Labour.avg}, materials $${anchors.Materials.avg}, service call $${anchors.Services.avg}.`;
}
